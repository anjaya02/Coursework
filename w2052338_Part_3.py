                ...
                if fail_credits not in [0, 20, 40, 60, 80, 100, 120]:
                    ...
                    if choice.lower() == "q":
                        ...
                        with open("progression_data.txt", "a") as f:
                            for data in progress_data:
                                f.write(f"Progress - {data[0]}, {data[1]}, {data[2]}\n")
                            for data in module_trailer_data:
                                f.write(f"Progress (module trailer) - {data[0]},{data[1]},{data[2]}\n")
                            for data in module_retriever_data:
                                f.write(f"Do not progress - Module retriever - {data[0]},{data[1]},{data[2]}\n")
                            for data in exclude_data:
                                f.write(f"Exclude - {data[0]},{data[1]},{data[2]}\n")
                        print("Part 3:")
                        try:
